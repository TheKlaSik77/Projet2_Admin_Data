Ce projet est une analyse d'un dataset Kaggle regroupant des offres d'emplois. L'objectif étant à terme de pouvoir prédire la colonne Avg_Salary en fonction d'une sélection de colonne. 
